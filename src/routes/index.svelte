...
<div class="text-center text-gray-700 text-xl">
    Powered by
    ...
    <div class="w-full flex-none -ml-full rounded-3xl bg-gray-100">
        <div class="w-full flex-none rounded-3xl transform shadow-lg bg-gradient-to-r from-red-500 to-orange-300 -rotate-2 sm:-rotate-2">
            <div class="grid grid-flow-col grid-rows-1 grid-cols-3">
                ...
                <div class="row-start-1 col-start-1 md:col-start-2 col-span-3 md:col-span-2 transform translate-x-4 md:translate-x-8 lg:translate-x-20 translate-y-4 md:translate-y-7 pt-6 px-4 md:px-6 lg:px-12 rounded-3xl text-left bg-white shadow-2xl">
                    <h2 class="text-gray-900 font-bold text-2xl mb-6">Who I am?&nbsp;👨‍💻</h2>
